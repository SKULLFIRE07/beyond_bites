...
const NotFound = () => {
  ...
  const popularPages = [
    ...
    { name: 'Order Now', href: '/contact', description: 'Get your Beyond Bites today' },
  ];
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mb-12">
            ...
            <p className="text-xl text-cocoa/80 mb-6 max-w-2xl mx-auto">
              Don't worry, even the sweetest journeys have unexpected detours. Let's get you back to discovering the pure goodness of Beyond Bites!
            </p>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-cocoa/80">
              Discover what makes Beyond Bites special
            </p>
          </div>
